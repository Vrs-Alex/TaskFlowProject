...
data class ServerStatusCode(val value: Int, val description: String) {
    ...
    companion object {
        ...
        public val ProxyAuthenticationRequired: ServerStatusCode = ServerStatusCode(407, "Proxy Authentication Required")
        ...
        public val RequestedRangeNotSatisfiable: ServerStatusCode = ServerStatusCode(416, "Requested Range Not Satisfiable")
        ...
        public val RequestHeaderFieldTooLarge: ServerStatusCode = ServerStatusCode(431, "Request Header Fields Too Large")
        ...
        public val VersionNotSupported: ServerStatusCode = ServerStatusCode(505, "HTTP Version Not Supported")
