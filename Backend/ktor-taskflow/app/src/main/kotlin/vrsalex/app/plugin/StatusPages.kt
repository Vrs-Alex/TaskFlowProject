...
import vrsalex.api.error.ServerErrorResponse
import vrsalex.api.error.ServerStatusCode
import io.ktor.http.*
    ...
    install(StatusPages) {
        ...
        exception<ContentTransformationException> { call, cause ->
            call.respond(
                ...
                message = mapOf(
                    "vrsalex/api/error" to "Invalid request body",
        ...
        exception<JsonConvertException> { call, cause ->
            call.respond(
                status = HttpStatusCode.BadRequest,
                message = mapOf(
                    "vrsalex/api/error" to "Invalid JSON format",
