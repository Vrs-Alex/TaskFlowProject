    ...
    AppBottomSheet(
        ...
        Column(Modifier.fillMaxWidth()) {
            ...
            Row(
                ...
                IconButton(
                    onClick = { onAction(AddItemContract.Action.Save) },
            ...
            LazyRow(
                ...
                item {
                    AppChipMenu(
                        ...
                        onItemSelected = { onAction(AddItemContract.Action.AreaChanged(it)) }
                    )
                }
                ...
                item {
                    AppMultiChipMenu(
                        ...
                        itemColor = { it.color },
                        placeholder = "# Теги",
                        onItemToggled = { onAction(AddItemContract.Action.TagToggled(it)) }
                    )
                }
            }
