...
val PrimaryDark = Color(0xFF3DB887)   // основной зелёный акцент
val OnPrimaryDark = Color(0xFF0A0E0D)   // почти чёрный — текст/иконка на primary
val PrimarySoftDark = Color(0x244DBFA0)
val PrimaryBorderDark = Color(0x594DBFA0)  // 35% — граница активного чипа/поля
